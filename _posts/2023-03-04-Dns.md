...
tags: [NextDNS, dns, adblock, networking, privacy, parental-controls]
description: "Block ads, trackers and adult content on every device with NextDNS. DNS-based filtering, nothing to install, covers phones, TVs and guest devices."
image:
  path: /assets/img/posts/dnsheader.webp
  alt: "NextDNS ad blocking header"
seo_title: "Block Ads on Every Device with NextDNS"
---
...
If you would rather run the filtering yourself, Pi-hole does the same job on your own hardware. Just know it can leave firewall rules behind, which is how I ended up with [broken Docker DNS](/posts/Broken-Docker-DNS-Due-to-PiHole/) later on.

> I am not associated with any products except this site [ashishghimire.com](https://ashishghimire.com) and its subdomains mentioned in the following article.
{: .prompt-tip }
